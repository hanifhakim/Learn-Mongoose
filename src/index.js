...
app.use(express.json()) //sebelumnya pake bodyparser.json()
app.get('/users', async (req, res) => { // READ all users
...
app.get('/users/:id', async (req, res) => { // READ one user by id
...
app.post('/users', async (req, res) => { // CREATE one user
...
app.patch('/users/:id', async (req, res) => { // update user by id
    ...
    //berisi array baru dgn nilai boolean
    if(!isValidOperation) {
